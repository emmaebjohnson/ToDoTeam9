...
export class TodoParent extends Component {
  state = {
    todo: [
      { id: 1, title: "Go out [ high]", completed: false, desc: "desc1" },
      { id: 2, title: "Go home [ low]", completed: false, desc: "desc2" },
      { id: 3, title: "Go to bed [medium]", completed: false, desc: "desc3" },
    ],
  };
